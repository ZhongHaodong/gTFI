function c_nm = upward_transposition(b,p,params_FMM)
...
for i =1:length(cell_leafLevel)
    ...
    c_nm(cell_leafLevel(i),:,:) =...
        sum(b(Index_Range(1):Index_Range(4),Index_Range(2):Index_Range(5),Index_Range(3):Index_Range(6))...
        .*cell_mask.*R_final,[1,2,3]);
