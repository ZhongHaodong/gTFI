function varargout = guibeta03withStrip(varargin)
% GUIBETA03WITHSTRIP MATLAB code for guibeta03withStrip.fig
%      GUIBETA03WITHSTRIP, by itself, creates a new GUIBETA03WITHSTRIP or raises the existing
%      singleton*.
%
%      H = GUIBETA03WITHSTRIP returns the handle to a new GUIBETA03WITHSTRIP or the handle to
%      the existing singleton*.
%
%      GUIBETA03WITHSTRIP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUIBETA03WITHSTRIP.M with the given input arguments.
%
%      GUIBETA03WITHSTRIP('Property','Value',...) creates a new GUIBETA03WITHSTRIP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before guibeta03withStrip_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to guibeta03withStrip_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help guibeta03withStrip

% Last Modified by GUIDE v2.5 24-Jul-2015 14:01:25
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @guibeta03withStrip_OpeningFcn, ...
                   'gui_OutputFcn',  @guibeta03withStrip_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before guibeta03withStrip is made visible.
function guibeta03withStrip_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to guibeta03withStrip (see VARARGIN)

% Choose default command line output for guibeta03withStrip
...
% UIWAIT makes guibeta03withStrip wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = guibeta03withStrip_OutputFcn(hObject, eventdata, handles) 
...
drawnow
[iField,voxel_size,matrix_size,CF,delta_TE,TE,B0_dir] = Read_DICOM_edt(FilePath);
