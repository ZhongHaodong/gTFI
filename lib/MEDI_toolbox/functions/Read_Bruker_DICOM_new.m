...
[real_p,voxel_size,matrix_size,CF,delta_TE,TE,NumEcho,Affine3D,B0_dir,minLoc]=Read_Bruker_DICOM_real(real_folder);
[imag_p,voxel_size,matrix_size,CF,delta_TE,TE,NumEcho,Affine3D,B0_dir,minLoc]=Read_Bruker_DICOM_real(imag_folder);
iField = real_p.*exp(1i*imag_p);
